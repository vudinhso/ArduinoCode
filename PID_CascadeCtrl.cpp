...
// ================================================================
// Variable declaration - Some variables are declared in the personal library
// ================================================================
// PID part. It could have been included in a personal library
// However, since the PID is the topic of interest, it wemains in the main file. 
...
void loop()
{
  ...
  if (abs(angleX) > 30)
    motor_cmd = 0; // motor stop when fall
